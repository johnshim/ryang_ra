...
def run(date, products, interval, simpleCorr=False, verbose=False, printMatrix=True, writeMatrix=False):
...
if __name__ == "__main__":
    ...
    for date in dates:
        for interval in intervals:
            run(date, products, interval, '-c' in sys.argv, '-v' in sys.argv, '-p' in sys.argv, '-w' in sys.argv)
